...
lblAddress.grid(row=4, column=0, padx=9,sticky="w")

txtAddress = Text(entries_frame, width=85, height=4, font=("Calibri", 16))
txtAddress.grid(row=5, column=0, columnspan=3, padx=10, sticky="w")
...
tree_frame.place(x=0, y=480, width=1364, height=700)
style = ttk.Style()
